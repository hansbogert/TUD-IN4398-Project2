...
const int NSIZE = 50;
const int WCV_SPEED = 5; // int meter per second
...
main (int argc, char *argv[])
{
  ...
  Ptr<ListPositionAllocator> positionList = CreateObject<ListPositionAllocator> ();
  ...
  int order[50] = { 42, 41, 46, 28, 8, 48, 43, 31, 26, 50, 36, 1, 27, 5, 49, 19, 18, 4, 10, 24, 20, 12, 39, 13, 9
                    , 2, 44, 23, 15, 25, 21, 37, 29, 14, 47, 17, 33, 38, 7, 45, 16, 35, 32, 11, 3, 40, 34, 6, 30, 22 };

  int arrivalTimes[50] = { 110702, 110725, 110777, 111113, 111776, 112461, 114579, 114660, 115627, 115639
  ...
  int chargingTimes[50] = { 11, 37, 305, 627, 653, 2092, 43, 957, 10, 199, 139, 254, 53, 33, 40, 29, 38, 100, 43, 245, 6, 1, 477, 167, 40
                     , 41, 42, 2, 11, 25, 44, 425, 499, 109, 47, 338, 1287, 164, 10, 31, 14, 120, 483, 176, 924, 2, 12, 63, 563, 1166 };

  WaypointMobilityModel waypointMobility;
  int time = 11625;
  Time waypointTime(time);
  Vector3D origin(0, 0, 0);
  Waypoint firstWaypoint(waypointTime, origin);
