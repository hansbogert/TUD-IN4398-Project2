 ...
 * 
 * \brief simple net device for simple things and testing for the IoT paper
 */
...
public:
  ...
  void SetChannel (Ptr<IotChannel> channel);

  /**
   * Attach a receive ErrorModel to the IotNetDevice.
   *
   * The IotNetDevice may optionally include an ErrorModel in
...
private:
   ...
   * due to the error model being active.  Although IotNetDevice doesn't 
